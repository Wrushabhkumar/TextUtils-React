    ...
    return (
        ...
        <div style={{ color: props.mode === 'light' ? 'black' : 'white' }}>
            ...
            <div className="mb-3" style={{backgroundColor: props.mode==='light'?'white':'#042743'}}>
                ...
                <button className="btn btn-primary mx-1 my-3"onClick={handleLwClick}>Lowercase</button>
                <button className="btn btn-primary mx-1 my-3"onClick={handleClearClick}>Cleare Text</button>
        ...
        <div className="conatainer" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>
            ...
            <p>{0.008 * text.split(" ").length} Minutes to Reade</p>
